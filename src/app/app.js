...
angular.module('app').controller('HomeController', ['$scope', '$rootScope', 'handleAnswersService', 'handleDataService', function ($scope, $rootScope, handleAnswersService, handleDataService) {
...
// Home Component with Routing (Routed / Stateful)
angular.module('app').component('result', result);

// Home Controller with dependency injection using the array method
angular.module('app').controller('ResultController', ['$scope', '$rootScope', 'handleAnswersService', 'handleResultService', function ($scope, $rootScope, handleAnswersService, handleResultService) {
...
angular.module('app').service('handleDataService', handleDataService);
...
angular.module('app').service('handleAnswersService', handleAnswersService);
...
angular.module('app').service('handleResultService', handleResultService);